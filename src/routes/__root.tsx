...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MiProjet+ — Structurez, scorez, financez votre activité" },
      { property: "og:description", content: "Application de structuration pour micro-activités, PME et startups. MIPROJET SCORE, suivi financier, certification et mise en relation." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MiProjet+ — Structurez, scorez, financez votre activité" },
      { name: "twitter:description", content: "Application de structuration pour micro-activités, PME et startups. MIPROJET SCORE, suivi financier, certification et mise en relation." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f4f6ffdd-c4cd-4540-b300-44160e412e07" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/f4f6ffdd-c4cd-4540-b300-44160e412e07" },
    ],
    links: [
